...
function toResponse(data, init) {
    ...
    if ((data === null || data === void 0 ? void 0 : data._flag) === "json") {
...
var getHTML = (apiReference, config)=>'<!doctype html>\n<html>\n  <head>\n    <title>Scalar API Reference</title>\n    <meta charset="utf-8" />\n    <meta\n      name="viewport"\n      content="width=device-width, initial-scale=1" />\n  </head>\n  <body>\n    <script\n      id="api-reference"\n      type="application/json">\n    '.concat(JSON.stringify(apiReference), "\n    </script>\n	 <script>\n      var configuration = {\n	  	favicon: ").concat((config === null || config === void 0 ? void 0 : config.logo) ? "data:image/svg+xml;utf8,".concat(encodeURIComponent(config.logo)) : void 0, " ,\n	   	theme: ").concat((config === null || config === void 0 ? void 0 : config.theme) || "saturn", ",\n        metaData: {\n			title: ").concat((config === null || config === void 0 ? void 0 : config.title) || "Open API Reference", ",\n			description: ").concat((config === null || config === void 0 ? void 0 : config.description) || "Better Call Open API", ",\n		}\n      }\n      document.getElementById('api-reference').dataset.configuration =\n        JSON.stringify(configuration)\n    </script>\n	  <script src=\"https://cdn.jsdelivr.net/npm/@scalar/api-reference\"></script>\n  </body>\n</html>");
// src/router.ts
var createRouter = (endpoints, config)=>{
    var _config_openapi, _config_routerMiddleware;
    if (!(config === null || config === void 0 ? void 0 : (_config_openapi = config.openapi) === null || _config_openapi === void 0 ? void 0 : _config_openapi.disabled)) {
        const openapi = {
            path: "/api/reference",
            ...config === null || config === void 0 ? void 0 : config.openapi
        };
    ...
    if (config === null || config === void 0 ? void 0 : (_config_routerMiddleware = config.routerMiddleware) === null || _config_routerMiddleware === void 0 ? void 0 : _config_routerMiddleware.length) {
    ...
    const processRequest = async (request)=>{
        ...
        const path = (config === null || config === void 0 ? void 0 : config.basePath) ? url.pathname.split(config.basePath).reduce((acc, curr, index)=>{
            if (index !== 0) {
                if (index > 1) {
                    acc.push("".concat(config.basePath).concat(curr));
                } else {
                    acc.push(curr);
                }
            }
        ...
        const context = {
            ...
            _flag: "router",
            asResponse: true,
            context: config === null || config === void 0 ? void 0 : config.routerContext
        };
        try {
    ...
    return {
        handler: async (request)=>{
            var _config_onRequest, _config_onResponse;
            const onReq = await (config === null || config === void 0 ? void 0 : (_config_onRequest = config.onRequest) === null || _config_onRequest === void 0 ? void 0 : _config_onRequest.call(config, request));
            if (onReq instanceof Response) {
                return onReq;
            }
            const req = onReq instanceof Request ? onReq : request;
            const res = await processRequest(req);
            const onRes = await (config === null || config === void 0 ? void 0 : (_config_onResponse = config.onResponse) === null || _config_onResponse === void 0 ? void 0 : _config_onResponse.call(config, res));
