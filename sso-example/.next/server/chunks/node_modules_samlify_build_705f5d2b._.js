...
"[project]/node_modules/samlify/build/src/utility.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
*/ var node_forge_1 = __turbopack_context__.r("[project]/node_modules/node-forge/lib/index.js [app-route] (ecmascript)");
var pako_1 = __turbopack_context__.r("[project]/node_modules/samlify/node_modules/pako/index.js [app-route] (ecmascript)");
 ...
 */ function zipObject(arr1, arr2, skipDuplicated) {
    ...
    return arr1.reduce(function(res, l, i) {
        ...
        if (res[l] !== undefined) {
            res[l] = Array.isArray(res[l]) ? res[l].concat(arr2[i]) : [
                res[l]
            ].concat(arr2[i]);
            return res;
        }
...
*/ function deflateString(message) {
    ...
    return Array.from((0, pako_1.deflate)(input, {
        raw: true
    }));
}
/**
...
*/ function inflateString(compressedString) {
    ...
    return Array.from((0, pako_1.inflate)(input, {
        raw: true
    })).map(function(byte) {
...
exports.default = utility; //# sourceMappingURL=utility.js.map
}}),
"[project]/node_modules/samlify/build/src/urn.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
exports.elementsOrder = elementsOrder; //# sourceMappingURL=urn.js.map
}}),
"[project]/node_modules/samlify/build/src/api.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var xmldom_1 = __turbopack_context__.r("[project]/node_modules/@xmldom/xmldom/lib/index.js [app-route] (ecmascript)");
var context = {
    validate: undefined,
...
exports.setDOMParserOptions = setDOMParserOptions; //# sourceMappingURL=api.js.map
}}),
"[project]/node_modules/samlify/build/src/extractor.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var xpath_1 = __turbopack_context__.r("[project]/node_modules/xpath/xpath.js [app-route] (ecmascript)");
var utility_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/utility.js [app-route] (ecmascript)");
var api_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/api.js [app-route] (ecmascript)");
var camelcase_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/camelcase/index.js [app-route] (ecmascript)"));
...
function extract(context, fields) {
    ...
    return fields.reduce(function(result, field) {
        ...
        */ if (index && attributePath) {
            ...
            var childXPath = buildAbsoluteXPath([
                (0, utility_1.last)(localPath)
            ].concat(attributePath));
        ...
        */ if (attributes.length > 1) {
            ...
            var childXPath_1 = "".concat(buildAbsoluteXPath([
                (0, utility_1.last)(localPath)
            ])).concat(attributeXPath);
            var attributeValues = baseNode.map(function(node) {
                ...
                var values = (0, xpath_1.select)(childXPath_1, nodeDoc).reduce(function(r, n) {
                    r[(0, camelcase_1.default)(n.name, {
                        locale: 'en-us'
                    })] = n.value;
                    return r;
                }, {});
...
exports.extract = extract; //# sourceMappingURL=extractor.js.map
}}),
"[project]/node_modules/samlify/build/src/metadata.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
*/ var fs = __importStar(__turbopack_context__.r("[externals]/fs [external] (fs, cjs)"));
var urn_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/urn.js [app-route] (ecmascript)");
var extractor_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/extractor.js [app-route] (ecmascript)");
var utility_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/utility.js [app-route] (ecmascript)");
...
exports.default = Metadata; //# sourceMappingURL=metadata.js.map
}}),
"[project]/node_modules/samlify/build/src/libsaml.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var utility_1 = __importStar(__turbopack_context__.r("[project]/node_modules/samlify/build/src/utility.js [app-route] (ecmascript)"));
var urn_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/urn.js [app-route] (ecmascript)");
var xpath_1 = __turbopack_context__.r("[project]/node_modules/xpath/xpath.js [app-route] (ecmascript)");
var node_rsa_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/node-rsa/src/NodeRSA.js [app-route] (ecmascript)"));
var xml_crypto_1 = __turbopack_context__.r("[project]/node_modules/xml-crypto/lib/index.js [app-route] (ecmascript)");
var xmlenc = __importStar(__turbopack_context__.r("[project]/node_modules/@authenio/xml-encryption/lib/index.js [app-route] (ecmascript)"));
var camelcase_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/camelcase/index.js [app-route] (ecmascript)"));
var api_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/api.js [app-route] (ecmascript)");
var xml_escape_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/xml-escape/index.js [app-route] (ecmascript)"));
var fs = __importStar(__turbopack_context__.r("[externals]/fs [external] (fs, cjs)"));
var xmldom_1 = __turbopack_context__.r("[project]/node_modules/@xmldom/xmldom/lib/index.js [app-route] (ecmascript)");
...
var libSaml = function() {
    ...
    */ function getQueryParamByType(type) {
        if ([
            urlParams.logoutRequest,
            urlParams.samlRequest
        ].indexOf(type) !== -1) {
            return 'SAMLRequest';
        }
        if ([
            urlParams.logoutResponse,
            urlParams.samlResponse
        ].indexOf(type) !== -1) {
            return 'SAMLResponse';
        }
    ...
    */ function createXPath(local, isExtractAll) {
    ...
    return {
        ...
        * @param  {SignatureVerifierOptions} opts cert declares the X509 certificate
         ...
         */ verifySignature: function(xml, opts) {
            ...
            return [
                false,
                null
            ]; // we didn't verify anything, none of the signatures are valid
        /*
        ...
        */ verifyMessageSignature: function(metadata, octetString, signature, verifyAlgorithm) {
            ...
            var key = new node_rsa_1.default(utility_1.default.getPublicKeyPemFromCertificate(signCert), 'public', {
                    ...
                    switch(_a.label){
                        case 0:
                             ...
                             */ if (!validate) {
                                ...
                                return [
                                    2 /*return*/ ,
                                    Promise.reject('Your application is potentially vulnerable because no validation function found. Please read the documentation on how to setup the validator. (https://github.com/tngan/samlify#installation)')
                                ];
                            }
                            _a.label = 1;
                        case 1:
...
exports.default = libSaml(); //# sourceMappingURL=libsaml.js.map
}}),
"[project]/node_modules/samlify/build/src/metadata-idp.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
*/ var metadata_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/samlify/build/src/metadata.js [app-route] (ecmascript)"));
var urn_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/urn.js [app-route] (ecmascript)");
var libsaml_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/samlify/build/src/libsaml.js [app-route] (ecmascript)"));
var utility_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/utility.js [app-route] (ecmascript)");
var xml_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/xml/lib/xml.js [app-route] (ecmascript)"));
/*
        ...
        if (!isFile) {
            ...
            if ((0, utility_1.isNonEmptyArray)(nameIDFormat)) {
                nameIDFormat.forEach(function(f) {
                    return IDPSSODescriptor_1.push({
                        NameIDFormat: f
                    });
                });
            }
...
exports.IdpMetadata = IdpMetadata; //# sourceMappingURL=metadata-idp.js.map
}}),
"[project]/node_modules/samlify/build/src/metadata-sp.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
        ...
        if (!isFile) {
            ...
            if ((0, utility_1.isNonEmptyArray)(singleLogoutService)) {
                singleLogoutService.forEach(function(a) {
                    ...
                    descriptors_1.SingleLogoutService.push([
                        {
                            _attr: attr
                        }
                    ]);
            ...
            if ((0, utility_1.isNonEmptyArray)(assertionConsumerService)) {
                ...
                assertionConsumerService.forEach(function(a) {
                    ...
                    descriptors_1.AssertionConsumerService.push([
                        {
                            _attr: attr
                        }
                    ]);
            ...
            var existedElements = elementsOrder.filter(function(name) {
                return (0, utility_1.isNonEmptyArray)(descriptors_1[name]);
            });
...
exports.SpMetadata = SpMetadata; //# sourceMappingURL=metadata-sp.js.map
}}),
"[project]/node_modules/samlify/build/src/binding-redirect.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
*/ var utility_1 = __importStar(__turbopack_context__.r("[project]/node_modules/samlify/build/src/utility.js [app-route] (ecmascript)"));
var libsaml_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/samlify/build/src/libsaml.js [app-route] (ecmascript)"));
var url = __importStar(__turbopack_context__.r("[externals]/url [external] (url, cjs)"));
var urn_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/urn.js [app-route] (ecmascript)");
...
*/ function buildRedirectURL(opts) {
    ...
    if (isSigned) {
        ...
        return baseUrl + pvPair(queryParam, octetString, noParams) + pvPair(urlParams.signature, encodeURIComponent(libsaml_1.default.constructMessageSignature(queryParam + '=' + octetString, entitySetting.privateKey, entitySetting.privateKeyPass, undefined, entitySetting.requestSignatureAlgorithm).toString()));
    }
...
*/ function loginResponseRedirectURL(requestInfo, entity, user, relayState, customTagReplacement) {
    ...
    if (metadata && metadata.idp && metadata.sp) {
        ...
        if (metadata.sp.isWantAssertionsSigned()) {
            rawSamlResponse = libsaml_1.default.constructSAMLSignature(__assign(__assign({}, config), {
...
exports.default = redirectBinding; //# sourceMappingURL=binding-redirect.js.map
}}),
"[project]/node_modules/samlify/build/src/binding-post.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
        ...
        return __generator(this, function(_a) {
            switch(_a.label){
                case 0:
                    ...
                    if (!(metadata && metadata.idp && metadata.sp)) return [
                        3 /*break*/ ,
                        3
                    ];
                    ...
                    if (!idpSetting.isAssertionEncrypted) return [
                        3 /*break*/ ,
                        2
                    ];
                    return [
                        4 /*yield*/ ,
                        libsaml_1.default.encryptAssertion(entity.idp, entity.sp, rawSamlResponse)
                    ];
                case 1:
                    context = _a.sent();
                    if (encryptThenSign) {
...
exports.default = postBinding; //# sourceMappingURL=binding-post.js.map
}}),
"[project]/node_modules/samlify/build/src/validator.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
exports.verifyTime = verifyTime; //# sourceMappingURL=validator.js.map
}}),
"[project]/node_modules/samlify/build/src/flow.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
exports.flow = void 0;
var utility_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/utility.js [app-route] (ecmascript)");
var validator_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/validator.js [app-route] (ecmascript)");
var libsaml_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/samlify/build/src/libsaml.js [app-route] (ecmascript)"));
var extractor_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/extractor.js [app-route] (ecmascript)");
var urn_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/urn.js [app-route] (ecmascript)");
            ...
            switch(_b.label){
                case 0:
                    ...
                    if (content === undefined) {
                        return [
                            2 /*return*/ ,
                            Promise.reject('ERR_REDIRECT_FLOW_BAD_ARGS')
                        ];
                    }
                ...
                case 1:
                    ...
                    return [
                        4 /*yield*/ ,
                        libsaml_1.default.isValidXml(xmlString)
                    ];
                case 2:
                    _b.sent();
                    return [
                ...
                case 3:
                    ...
                    return [
                        2 /*return*/ ,
                        Promise.reject('ERR_INVALID_XML')
                    ];
                case 4:
                    // check status based on different scenarios
                    return [
                        4 /*yield*/ ,
                        checkStatus(xmlString, parserType)
                    ];
                case 5:
                    // check status based on different scenarios
                    _b.sent();
                    ...
                    if (checkSignature) {
                        if (!signature || !sigAlg) {
                            return [
                                2 /*return*/ ,
                                Promise.reject('ERR_MISSING_SIG_ALG')
                            ];
                        }
                        ...
                        if (!verified) {
                            ...
                            return [
                                2 /*return*/ ,
                                Promise.reject('ERR_FAILED_MESSAGE_SIGNATURE_VERIFICATION')
                            ];
                        }
                    ...
                    if ((parserType === 'LogoutResponse' || parserType === 'SAMLResponse') && extractedProperties && extractedProperties.issuer !== issuer) {
                        return [
                            2 /*return*/ ,
                            Promise.reject('ERR_UNMATCH_ISSUER')
                        ];
                    }
                    // invalid session time
                    // only run the verifyTime when `SessionNotOnOrAfter` exists
                    if (parserType === 'SAMLResponse' && extractedProperties.sessionIndex.sessionNotOnOrAfter && !(0, validator_1.verifyTime)(undefined, extractedProperties.sessionIndex.sessionNotOnOrAfter, self.entitySetting.clockDrifts)) {
                        return [
                            2 /*return*/ ,
                            Promise.reject('ERR_EXPIRED_SESSION')
                        ];
                    }
                    // invalid time
                    // 2.4.1.2 https://docs.oasis-open.org/security/saml/v2.0/saml-core-2.0-os.pdf
                    if (parserType === 'SAMLResponse' && extractedProperties.conditions && !(0, validator_1.verifyTime)(extractedProperties.conditions.notBefore, extractedProperties.conditions.notOnOrAfter, self.entitySetting.clockDrifts)) {
                        return [
                            2 /*return*/ ,
                            Promise.reject('ERR_SUBJECT_UNCONFIRMED')
                        ];
                    }
                    return [
                        2 /*return*/ ,
        ...
        return __generator(this, function(_d) {
            switch(_d.label){
                case 0:
                    ...
                    return [
                        4 /*yield*/ ,
                        libsaml_1.default.isValidXml(samlContent)
                    ];
                case 1:
                    // validate the xml first
                    _d.sent();
                    ...
                    return [
                        4 /*yield*/ ,
                        checkStatus(samlContent, parserType)
                    ];
                case 2:
                    // check status based on different scenarios
                    _d.sent();
                    ...
                    if (!(decryptRequired && verified && parserType === 'SAMLResponse' && verifiedAssertionNode)) return [
                        3 /*break*/ ,
                        4
                    ];
                    return [
                        4 /*yield*/ ,
                        libsaml_1.default.decryptAssertion(self, verifiedAssertionNode)
                    ];
                case 3:
                    result = _d.sent();
                ...
                case 4:
                    if (!(decryptRequired && !verified)) return [
                        3 /*break*/ ,
                        6
                    ];
                    return [
                        4 /*yield*/ ,
                        libsaml_1.default.decryptAssertion(self, samlContent)
                    ];
                case 5:
                    result = _d.sent();
                    ...
                    if (decryptedDocVerified) {
                        ...
                        return [
                            2 /*return*/ ,
                            Promise.reject('FAILED_TO_VERIFY_SIGNATURE')
                        ];
                    }
                    return [
                        3 /*break*/ ,
            ...
            switch(_b.label){
                case 0:
                    ...
                    if (encodedRequest === undefined) {
                        return [
                            2 /*return*/ ,
                            Promise.reject('ERR_SIMPLESIGN_FLOW_BAD_ARGS')
                        ];
                    }
...
exports.flow = flow; //# sourceMappingURL=flow.js.map
}}),
"[project]/node_modules/samlify/build/src/entity.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
*/ var utility_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/utility.js [app-route] (ecmascript)");
var urn_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/urn.js [app-route] (ecmascript)");
var uuid = __importStar(__turbopack_context__.r("[project]/node_modules/uuid/dist/esm-node/index.js [app-route] (ecmascript)"));
var metadata_idp_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/samlify/build/src/metadata-idp.js [app-route] (ecmascript)"));
var metadata_sp_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/samlify/build/src/metadata-sp.js [app-route] (ecmascript)"));
var binding_redirect_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/samlify/build/src/binding-redirect.js [app-route] (ecmascript)"));
var binding_post_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/samlify/build/src/binding-post.js [app-route] (ecmascript)"));
var flow_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/flow.js [app-route] (ecmascript)");
...
exports.default = Entity; //# sourceMappingURL=entity.js.map
}}),
"[project]/node_modules/samlify/build/src/binding-simplesign.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
exports.default = simpleSignBinding; //# sourceMappingURL=binding-simplesign.js.map
}}),
"[project]/node_modules/samlify/build/src/entity-idp.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
*/ var entity_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/samlify/build/src/entity.js [app-route] (ecmascript)"));
var libsaml_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/samlify/build/src/libsaml.js [app-route] (ecmascript)"));
var urn_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/urn.js [app-route] (ecmascript)");
var binding_post_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/samlify/build/src/binding-post.js [app-route] (ecmascript)"));
var binding_redirect_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/samlify/build/src/binding-redirect.js [app-route] (ecmascript)"));
var binding_simplesign_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/samlify/build/src/binding-simplesign.js [app-route] (ecmascript)"));
var flow_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/flow.js [app-route] (ecmascript)");
var utility_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/utility.js [app-route] (ecmascript)");
/**
    ...
    function IdentityProvider(idpSetting) {
        ...
        if (idpSetting.loginResponseTemplate) {
            if ((0, utility_1.isString)(idpSetting.loginResponseTemplate.context) && Array.isArray(idpSetting.loginResponseTemplate.attributes)) {
                ...
                entitySetting.loginResponseTemplate = __assign(__assign({}, entitySetting.loginResponseTemplate), {
            ...
            return __generator(this, function(_b) {
                switch(_b.label){
                    ...
                    case 1:
                        return [
                            4 /*yield*/ ,
                            binding_post_1.default.base64LoginResponse(requestInfo, {
                                idp: this,
                                sp: sp
                    ...
                    case 3:
                        return [
                            4 /*yield*/ ,
                            binding_simplesign_1.default.base64LoginResponse(requestInfo, {
                                idp: this,
                                sp: sp
                    ...
                    case 5:
                        return [
                            2 /*return*/ ,
                            binding_redirect_1.default.loginResponseRedirectURL(requestInfo, {
                                idp: this,
                                sp: sp
                            }, user, relayState, customTagReplacement)
                        ];
...
exports.IdentityProvider = IdentityProvider; //# sourceMappingURL=entity-idp.js.map
}}),
"[project]/node_modules/samlify/build/src/entity-sp.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    */ ServiceProvider.prototype.createLoginRequest = function(idp, binding, customTagReplacement) {
        ...
        switch(protocol){
            case nsBinding.redirect:
                return binding_redirect_1.default.loginRequestRedirectURL({
                    idp: idp,
                    sp: this
                }, customTagReplacement);
            case nsBinding.post:
...
exports.ServiceProvider = ServiceProvider; //# sourceMappingURL=entity-sp.js.map
}}),
"[project]/node_modules/samlify/build/index.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
// version <= 1.25
var entity_idp_1 = __importStar(__turbopack_context__.r("[project]/node_modules/samlify/build/src/entity-idp.js [app-route] (ecmascript)"));
...
var entity_sp_1 = __importStar(__turbopack_context__.r("[project]/node_modules/samlify/build/src/entity-sp.js [app-route] (ecmascript)"));
...
var metadata_idp_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/metadata-idp.js [app-route] (ecmascript)");
...
var metadata_sp_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/metadata-sp.js [app-route] (ecmascript)");
...
var libsaml_1 = __turbopack_context__.r("[project]/node_modules/samlify/build/src/libsaml.js [app-route] (ecmascript)");
...
var Constants = __importStar(__turbopack_context__.r("[project]/node_modules/samlify/build/src/urn.js [app-route] (ecmascript)"));
exports.Constants = Constants;
var Extractor = __importStar(__turbopack_context__.r("[project]/node_modules/samlify/build/src/extractor.js [app-route] (ecmascript)"));
...
//# sourceMappingURL=node_modules_samlify_build_705f5d2b._.js.map