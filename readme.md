...
This repository contains a set of small, framework-specific projects that demonstrate how to implement authentication with [Better Auth](https://better-auth.com/).

### Examples

- [**astro-example**](astro-example): Astro app with email/password auth, protected dashboard, and a two-factor authentication flow.
...
- [**tanstack-example**](tanstack-example): TanStack Router + React app with protected routes, SSR entry, and a simple login flow.
